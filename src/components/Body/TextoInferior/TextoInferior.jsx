...
const TextoInferior = ({classname}) =>{
    return <ul>
                ...
                <li>Interactividad: A medida que cuidas tus plantas, verás cómo crecen y se desarrollan. Cada acción influye en su salud y apariencia, creando una experiencia inmersiva y divertida.</li>
                <li>Notificaciones y Consejos: Recibe recordatorios y recomendaciones sobre cómo cuidar tus plantas. ¡Nunca dejarás que se marchiten! </li>
            </ul>
}
